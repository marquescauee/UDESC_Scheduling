...
from constraints import ConstraintHard, ConstraintSoft, DiasNaoMinistradasHard, DiasNaoMinistradasSoft, DeveSerNoiteCheiaHard, DeveSerNoiteCheiaSoft
...
class ReadData:
    ...
    def read_disciplinas(self):
        ...
        for linha in data:
            ...
            soft_constraints = [DiasNaoMinistradasSoft(False, linha[9],linha[10]), DeveSerNoiteCheiaSoft(False, linha[11], linha[12])]
            disciplina = Disciplina(i, self.cacheProfessores[linha[0]], linha[1], linha[2], linha[3], linha[4], hard_constraints, soft_constraints)  ## como la em cima ta setado as cols aqui tem q fazer tbm, bem meme
...
class SingleSolution:
    ...
    def generate_solution(self):
        ...
        matriz1Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf1 = gerar(matriz1Fase, self.data.primeiraFase)
        self.totalConflitos += conf1

        matriz2Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf2 = gerar(matriz2Fase, self.data.segundaFase)
        self.totalConflitos += conf2

        matriz3Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf3 = gerar(matriz3Fase, self.data.terceiraFase)
        self.totalConflitos += conf3

        matriz4Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf4 = gerar(matriz4Fase, self.data.quartaFase)
        self.totalConflitos += conf4

        matriz5Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf5 = gerar(matriz5Fase, self.data.quintaFase)
        self.totalConflitos += conf5

        matriz6Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf6 = gerar(matriz6Fase, self.data.sextaFase)
        self.totalConflitos = + conf6

        matriz7Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf7 = gerar(matriz7Fase, self.data.setimaFase)
        self.totalConflitos += conf7

        matriz8Fase = [[None, None], [None, None], [None, None], [None, None], [None, None], [None, None]]
        conf8 = gerar(matriz8Fase, self.data.oitavaFase)
        self.totalConflitos += conf8

        self.grade = [matriz1Fase,matriz2Fase,matriz3Fase,matriz4Fase,matriz5Fase,matriz6Fase, matriz7Fase, matriz8Fase] #grade de todas as fasese
